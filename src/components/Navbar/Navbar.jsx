  ...
  return (
    <div  className="bg-blue-900 dark:bg-black shadow-md text-white h-[65px] lg:h-[85px] flex fixed top-0 left-0 right-0 z-50">
      <nav className="container mx-auto px-4 py-3 md:flex md:items-center md:justify-between">
        ...
        <div
          className={`md:flex items-center md:space-x-6 dark:bg-black ${
            mobileMenuOpen ? "block bg-blue-900" : "hidden"
          } ${
            user
              ? " ml-32 shadow-lg md:bg-transparent p-4"
              : "bg-opacity-40"
          }`}
        >
          <Link
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div
                id="dropdownNavbar"
                className="z-10 absolute top-full md:mt-4 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-black dark:divide-gray-600"
              >
                <ul
                  ...
                  <li>
                    <Link
                      ...
                      className={`flex justify-end mt-2 md:mt-0 md:inline-block ${
                        activeLink === "about"
                          ? "text-emerald-500 font-medium"
                          : "text-black  lg:dark:text-white dark:text-black  md:text-gray-600 bg-slate-100 md:bg-transparent py-2 rounded-sm pe-3 font-medium"
                      }`}
                    >
                      About
                    </Link>
                    ...
                    <Link
                      ...
                      className={`flex justify-end mt-2 md:mt-0 md:inline-block ${
                        activeLink === "howwework"
                          ? "text-emerald-500 font-medium"
                          : "dark:text-black  lg:dark:text-white md:text-gray-600 bg-slate-100 md:bg-transparent py-2 rounded-sm pe-3 font-medium"
                      }`}
                    >
                      How we Work
                    </Link>
